...
\section{\sc Who I Am}
Community Builder. Human Genomic Data Sharing Expert. Open Science Advocate.
...
%{\em BlueSky:} \href{https://bsky.app/profile/malloryfreeberg.bsky.social}{\textcolor{blue}{malloryfreeberg.bsky.social}} & {\em Google Scholar:} \href{https://scholar.google.com/citations?user=2LCcJA0AAAAJ&hl=en}{\textcolor{blue}{Mallory A Freeberg}} \\
{\em EMBL-EBI site:} \href{https://www.ebi.ac.uk/about/teams/human-genomics/}{\textcolor{blue}{Human Genomics Team}} & {\em Google Scholar:} \href{https://scholar.google.com/citations?user=2LCcJA0AAAAJ&hl=en}{\textcolor{blue}{Mallory A Freeberg}} \\
\end{tabular}
% {\em Pronouns:} she/her
%Hinxton, Cambridgeshire, CB10 1SD, UK

%\section{\sc Research Interests}
%Genomics/genetics; post-transcriptional gene regulation; high-throughput sequencing technologies; data sharing and reuse; open-source tools and platforms enabling life sciences research
...
\begin{itemize}
\itemsep0em 
	\item Leading the European Genome-phenome Archive team and the Federated EGA community for appropriate sharing of sensitive human data for research
	...
	\item Building international communities on a mission to enable research and clinical applications of human genomics data, for example via the Global Alliance for Genomics and Health (GA4GH) and ELIXIR.
	\item Leading teams on the Ensembl project, a foundational resource providing scientists with data and tools to study genomes across all domains of life
\end{itemize}

{\em Coordinator}, European Genome-phenome Archive \hfill {Jun 2021 - Apr 2024}
\begin{itemize}
\itemsep0em 
	\item Led establishment of the Federated EGA Network for transnational discovery of and access to sensitive human data (\href{https://www.nature.com/articles/s41588-025-02101-9}{\textcolor{blue}{publication}})
	...
	\item Managed a 14-person team responsible for operating production data archive services (\href{https://doi.org/10.1093/nar/gkab1059}{\textcolor{blue}{publication}})
\end{itemize}
...
\begin{itemize}
\itemsep0em 
	\item Coordinated data wrangling work for 6-person team across UK and US institutions
...
\itemsep0em 
	...
	\item Created training materials and computational workflows to support open and reproducible transcriptomics research (\href{https://training.galaxyproject.org/training-material/hall-of-fame/malloryfreeberg/}{\textcolor{blue}{contributions}})
\end{itemize}
...
Dissertation: Computational analysis of the post-transcriptional gene regulatory network (\href{https://deepblue.lib.umich.edu/bitstream/handle/2027.42/111339/mafree_1.pdf?sequence=1&isAllowed=y}{\textcolor{blue}{PDF thesis}})
...
% Copy EuropePMC citation and add bold (my name) and italics (journal name, et al) where needed

Yates AD, Austine-Orimoloye O, Azov AG, et al. Ensembl 2026. Nucleic Acids Research. 2026 Jan;54(D1):D1053-D1060. DOI: 10.1093/nar/gkaf1239. PMID: 41296548; PMCID: PMC12807669.

Thakur M, Bosc N, Brooksbank C, et al. EMBL's European Bioinformatics Institute (EMBL-EBI) in 2025. Nucleic Acids Research. 2026 Jan;54(D1):D10-D19. DOI: 10.1093/nar/gkaf1078. PMID: 41233952; PMCID: PMC7618448.

D'Altri T*, Freeberg MA*, Curwin AJ, et al. The Federated European Genome-Phenome Archive as a global network for sharing human genomics data. {\em Nature Genetics}. 2025 Mar;57(3):481-485. DOI: 10.1038/s41588-025-02101-9. PMID: 40033058.

Laurie S, Steyaert W, de Boer E, {\em et al.} Genomic reanalysis of a pan-European rare-disease resource yields new diagnoses. {\em Nature Medicine}. 2025 Feb;31(2):478-489. DOI: 10.1038/s41591-024-03420-w. PMID: 39825153; PMCID: PMC11835725.

%Dyer SC, Austine-Orimoloye O, Azov AG, {\em et al.} Ensembl 2025. {\em Nucleic Acids Research}. 2025 Jan;53(D1):D948-D957. DOI: 10.1093/nar/gkae1071. PMID: 39656687; PMCID: PMC11701638.

%Thakur M, Brooksbank C, Finn RD, {\em et al.} EMBL's European Bioinformatics Institute (EMBL-EBI) in 2024. {\em Nucleic Acids Research}. 2025 Jan;53(D1):D10-D19. DOI: 10.1093/nar/gkae1089. PMID: 39607697; PMCID: PMC11701561.

Rujano MA, Boiten JW, Ohmann C, {\em et al.} Sharing sensitive data in life sciences: an overview of centralized and federated approaches. {\em Briefings in Bioinformatics}. 2024 May;25(4):bbae262. DOI: 10.1093/bib/bbae262. PMID: 38836701; PMCID: PMC11151787.

Corvò A, Matalonga L, Spalding D, {\em et al.} Remote visualization of large-scale genomic alignments for collaborative clinical research and diagnosis of rare diseases. {\em Cell Genomics}. 2023 Feb;3(2):100246. DOI: 10.1016/j.xgen.2022.100246. PMID: 36819661; PMCID: PMC9932977.

Freeberg MA, Fromont LA, D'Altri T, {\em et al.} The European Genome-phenome Archive in 2021. {\em Nucleic Acids Research}. 2022 Jan;50(D1):D980-D987. DOI: 10.1093/nar/gkab1059. PMID: 34791407; PMCID: PMC8728218.

Rehm HL, Page AJH, Smith L, {\em et al.} GA4GH: International policies and standards for data sharing across genomic research and healthcare. {\em Cell Genomics}. 2021 Nov;1(2):100029. DOI: 10.1016/j.xgen.2021.100029. PMID: 35072136; PMCID: PMC8774288.

Füllgrabe A, George N, Green M, {\em et al.} Guidelines for reporting single-cell RNA-seq experiments. {\em Nature Biotechnology}. 2020 Dec;38(12):1384-1386. DOI: 10.1038/s41587-020-00744-z. PMID: 33188371; PMCID: PMC9302581.
...
%Title. {\em Conference/Event}; MMM YYYY; City, 2-letter Country Code (link to materials)

The Federated European Genome- Phenome Archive: Enabling Global Access to Human Genomics Data. \\
{\em Festival of Genomics and Biodata}; Jan 2026; London, UK

The Evolution of Ensembl: Scaling for Accessibility, Performance, and Interoperability. \\
{\em ISMB/ECCB: NIH-ELIXIR session}; Jul 2025; Liverpool, UK

Global data resources for human genomics and health. (\href{https://zenodo.org/records/13845933}{\textcolor{blue}{slides}}) \\
{\em Australian BioCommons Webinar}; Sep 2024; Melbourne, AU

Federated EGA: Providing global discovery and access for sensitive human data. (\href{https://docs.google.com/presentation/d/1P9KMd-NAjbz1f9fgO9FVuyYTVAoYZoJAqL0wvnVNrt4/edit?usp=sharing}{\textcolor{blue}{slides}}) \\
{\em ISMB/ECCB}; Jul 2023; Lyon, FR

The Federated EGA: Global discovery and access for sensitive human data. (\href{https://docs.google.com/presentation/d/17wJu5ntPdT1Uj3kSOd_ROHY0DK7IzRwRq6Lgyvso2aw/edit?usp=sharing}{\textcolor{blue}{slides}}) \\
{\em GA4GH 10th Plenary}; Sep 2022; Barcelona, ES
...
%FAIR principles and promoting openness in the life sciences. (\href{https://docs.google.com/presentation/d/1BNdhj_Ny7qJ84xmoUuzqIicYXF3UwwcGdJTLtyZkV5I/edit?usp=sharing}{\textcolor{blue}{slides}}) \\
%{\em NIHR Statistics Group Workshop}; Feb 2022; virtual

The European Genome-phenome Archive Metadata Model. (\href{https://docs.google.com/presentation/d/14x9PNs3j5mNZWIHBW9k6aiJUekiLYsrbrkpaMihB4ko/edit?usp=sharing}{\textcolor{blue}{slides}}) \\
{\em GHGA Workshop on Metadata in Biomedical Genome Research}; Jun 2021; virtual
...
\section{\sc Selected\\ Workshops}

%Title. {\em Conference/Event}; MMM YYYY; City, 2-letter Country Code (link to materials)

Genomic Variant Interpretation \& prioritisation for clinical research. {\em ISMB/ECCB 2025 Tutorial Workshop}; Jul 2025; Liverpool, UK; Scientific Organiser and Speaker (\href{https://www.iscb.org/ismbeccb2025/programme-agenda/tutorials#ip3/}{\textcolor{blue}{workshop}})

Exploring gene and environmental exposure interactions to understand human health and disease. {\em EMBL-EBI Training Course}; Feb 2024; Cambridge, UK; Scientific Organiser and Speaker (\href{https://https://www.ebi.ac.uk/training/events/exploring-gene-and-environmental-exposure-interactions-understand-human-health-and-disease/}{\textcolor{blue}{course}})
...
\section{\sc Leadership \& Community Roles}

{\em Member, Federated EGA Strategic Committee} (Oct 2025 - Present)\\
Coordinate with Committee members in fulfilment of strategic responsibilities and to make progress towards shared goals and milestones

{\em Affiliate Member, Impact of Genomic Variation on Function (IGVF) Consortium} (Apr 2025 - Present)\\
Foster data and knowledge exchange between EMBL-EBI services and IGVF to enable the assessment of the impact of genomic variation on genome function and phenotype

{\em Member, NextGen's Scientific, Social Sciences and Humanities Board} (Oct 2024 - Present)\\
Provide strategic advice to ensure that scientific rigor and ethical and societal considerations are integrated into NextGen's research outputs and stakeholder engagement

{\em Co-lead, GA4GH Implementation Forum} (Mar 2024 - Present)\\
Support adoption of GA4GH products and tools, working closely with organisations in the genomics and health community to address key challenges and promote best practices in genomic data sharing
...
{\em Coordinator, ELIXIR Federated Human Data Community} (Feb 2022 - Apr 2024)\\
...
{\em Chair, Federated EGA Operations Committee} (Jan 2021 - Apr 2024)\\
Lead Committee in fulfilment of operational responsibilities, coordinate with Committee members to make progress towards shared goals and milestones

\section{\sc Teaching \& Mentoring}
%\section{\sc Mentoring}

{\em Mentor, \href{https://elixir-europe.org/internal-projects/elead2/}{\textcolor{blue}{ELIXIR’s LEadership And Diversity mentoring programme}}} (Apr 2025 - Present)\\
Supporting women's leadership growth in ELIXIR through individual and structure mentorship in particular to support career development

{\em Mentor, \href{https://bioinfo4women.bsc.es/}{\textcolor{blue}{Bioinfo4Women}}} (Jul 2024 - Mar 2025)\\
Promote research done by women in computational biology with a focus on their transition from postdoc to junior independent positions
...
%{\em Instructor, Johns Hopkins University}, Baltimore, MD USA (Jan 2017 - May 2017)\\
%Created materials for and ran the Advanced Academic Program online course "Bioinformatics: Tools for Genome Analysis"
...
ELIXIR LEadership And Diversity (ELEAD) mentoring programme \hfill {2023-2024}\\
